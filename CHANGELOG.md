...
## [1.4.7] - UNRELEASED [DOCS-IMPROVEMENTS]

### Added
- Log build result in make target.
- Live log status context menu to reset the status text to the default connected message.
