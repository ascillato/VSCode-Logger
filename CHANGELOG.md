...
### Added
- Option to show or hide Bastion related fields.

### Changed
- Device's ID is no longer editable and now is internal, unique and autogenerated.
- Update dependencies to latest.

### Deprecated
- Deprecated the configuration of device ID.
