...
* **Document your changes**: update `README.md`, this file `CONTRIBUTING.md` and `AGENTS.md` when adding features or altering workflows. Explain new configuration fields, UI elements and behaviours clearly.
